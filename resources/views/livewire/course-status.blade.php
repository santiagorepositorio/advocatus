            ...
            <div class="px-6 py-4">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div class="flex justify-around items-center gap-3">
                        @if($statusr == 1)                        
                            <div class="pointer-events-auto relative inline-flex items-center rounded-md bg-blue-500 text-[0.8125rem] font-medium leading-5 text-white shadow-sm ring-1  hover:bg-slate-50 hover:text-slate-900 fill-white hover:fill-slate-900">
                        ...
                        @elseif($statusr == 2)
                        <div class="pointer-events-auto relative inline-flex items-center rounded-md bg-yellow-500 text-[0.8125rem] font-medium leading-5 text-white shadow-sm ring-1  hover:bg-slate-50 hover:text-slate-900 fill-white hover:fill-slate-900">
                            <div class="flex px-3 py-2 gap-2">
