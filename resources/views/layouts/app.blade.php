    ...
    <footer class=" container p-4 bg-white sm:p-6 dark:bg-gray-900 mb-3">
        ...
        <div class="md:flex md:justify-between">
            ...
            <div class="flex-shrink-0 flex items-center mb-6">
                <a href="/" class="flex-shrink-0 flex items-center mx-6">
                    <img class="block lg:hidden h-12 w-auto" src="{{ asset('assets/imgs/logo/logo-top-1.png') }}"
                        alt="ITSW">
                    <img class="hidden lg:block h-12 w-auto" src="{{ asset('assets/imgs/logo/logo-top-2.png') }}"
                        alt="ITSW">
                </a>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                    href="https://sobotredsystems.com/" class="hover:underline">Sobotred Systems™</a>. All Rights
                Reserved.
            </span>
