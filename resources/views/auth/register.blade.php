        ...
        <div class="w-full h-screen flex items-center justify-center">
            <div class="w-full sm:w-5/6 md:w-2/3 lg:w-1/2 xl:w-1/3 2xl:w-1/4 h-full bg-white flex items-center justify-center">
                <div class="w-full px-12">
                    ...
                    <p class="text-center text-sm text-gray-600 mt-2">Already have an account? <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-700 hover:underline" title="Sign In">Sign in here</a></p>
                    <x-jet-validation-errors class="mb-4" />
                    <form method="POST" action="{{ route('register') }}" class="my-8 text-sm">
                        @csrf                        
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="remember_me" class="text-gray-700">I accept the 
                                <a href="{{ route('terms.show') }}" class="text-blue-600 hover:text-blue-700 hover:underline">terms</a> and 
                                <a href="{{ route('policy.show') }}" class="text-blue-600 hover:text-blue-700 hover:underline">privacy policy</a>
                            </label>
                        </div>
                        @endif
