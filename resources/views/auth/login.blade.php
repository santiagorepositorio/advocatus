            ...
            <div class="w-full p-8 lg:w-1/2">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <input id="password"  class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                    ...
                    <div class="mt-8">
                        ...
                        <x-jet-button class="bg-blue-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600">
                            {{ __('Log in') }}
                        </x-jet-button>
                    </div>
                    <div class="mt-4 flex items-center justify-between">
